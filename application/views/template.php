    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" >INVENTARIS BARANG</a>
            </div>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Agus</b> deleted account</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Fuad</b> commented your post</h4>
                                                <p>
                                ...
                                <ul class="menu tasks">
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar bg-pink" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 10%">
                                                </div>
                                            </div>
                                        </a>
                                    </li>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?=base_url()?>index.php/profil/deva"><i class="material-icons">person</i>Profile</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                    <li>
                        <a href="<?= base_url('index.php/profil/deva')?>">
                    ...
                    <li>
                        <a href="<?= base_url('index.php/peminjam')?>">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 - 2019 <a href="javascript:void(0);">User</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 2.0.1
                </div>
